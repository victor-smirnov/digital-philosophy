...
Note that positive test on functional (behavioral) consciousness does not necessary imply substance (or, "true") Consciousness. The question about the latter is just considered irrelevant here. What is relevant is that, for example, once the _Agency_ function (taking responsibility) reaches level of mature humans, such AI may act as a _person_ in interactions with humans. So, strictly speaking, we don't need an AI to be "truly conscious" to have rights and dignity (at least their "digital" counterparts). It's sufficient that an AI just behaves correctly in corresponding situations. This position will much easier to defend rationally than its negative counterpart.
