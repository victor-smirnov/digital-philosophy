...
Let me rephrase it. We used to think that human consciousness is not 100% dependent of language we are using for _external communication_, and there is a hard physiological evidence for that. But besides external language, there are many internal languages defined as a structured sequences of memory states, and there are a lot of those languages, given that there are a lot of different memory buffers in the brain. 
